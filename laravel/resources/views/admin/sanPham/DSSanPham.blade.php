            ...
            <div class="card-header py-3">
                ...
                <form action="{{ route('san-pham.xoa-nhieu') }}" method="post">
                    ...
                    <div class="float-left">
                        ...
                        <a href="{{ route('san-pham.them-san-pham') }}"><button type="button"
                        ...
                        <tbody>
                            @foreach ($DSSanPham as $item)
                                <tr>
                                    ...
                                    @endif
                                    <td class="col-2 align-middle"><a href="{{ route('san-pham.sua-san-pham', $item->id) }}"
                                            class="btn btn-secondary btn-sm">Sửa</a> |
                                        <a href="{{ route('san-pham.delete', $item->id) }}"
