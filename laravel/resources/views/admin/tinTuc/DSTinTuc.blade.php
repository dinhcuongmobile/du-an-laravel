    ...
    <form action="{{route('tin-tuc.xoa-nhieu')}}" method="post">
        ...
        <div class="card shadow mb-4">
            <div class="card-header py-3">
                ...
                <a href="{{route('tin-tuc.them-tin-tuc')}}"><button type="button" class="btn btn-secondary btn-sm">Nhập thêm</button></a>
                        ...
                        <tbody>
                            @foreach ($DSTinTuc as $index => $item)
                                <tr>
                                    ...
                                    <td class="col-2 align-middle"><a href="{{route('tin-tuc.sua-tin-tuc',$item->id)}}" class="btn btn-secondary btn-sm">Sửa</a> |
                                        <a href="{{route('tin-tuc.delete',$item->id)}}" class="btn btn-secondary btn-sm">Xóa</a></td>
                                </tr>
                            @endforeach
